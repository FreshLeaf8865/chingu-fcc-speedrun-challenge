...
const Home = (props) => (
  <div className="home__container">
    <div className="home__title">Recipe Box</div>
    {props.edit === null
      ? <Collapse accordion={true} className="home__collapse">
        {parseItems(props)}
      </Collapse>
      : <Collapse accordion={true} className="home__collapse" activeKey={String(props.edit)} style={styleEdit}>
        {parseItems(props)}
      </Collapse>
    }
    {props.edit === null && <div className="home__button-add"><Button handleClick={props.handleAdd} value="Add" color="primary"/></div>}
  </div>
);
